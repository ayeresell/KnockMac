...
final class KnockDetector {
    ...
    init() {
        ...
        wire()
        print("[Detector] v2 initialized — k=5.0 absFloor=0.030 attack≤20 minPeak=0.065g zDom=disabled ampRatio≤4.0 attackRatio≤10.0 gap=[0.15,0.5]s gate=0.5s cooldown=0.15s")
    }
